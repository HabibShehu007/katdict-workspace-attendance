          ...
          >
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative flex items-center">
                <User className="absolute left-4 w-5 h-5 text-zinc-400 dark:text-zinc-500" />
                <input
                  required
                  type="text"
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative flex items-center">
                <Mail className="absolute left-4 w-5 h-5 text-zinc-400 dark:text-zinc-500" />
                <input
                  required
                  type="email"
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative flex items-center">
                <Lock className="absolute left-4 w-5 h-5 text-zinc-400 dark:text-zinc-500" />
                <input
                  required
                ...
                <button
                  ...
                  className="absolute right-4 p-1 text-zinc-400 hover:text-zinc-600 dark:hover:text-zinc-200 transition-colors"
                >
                  {showPassword ? (
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full mt-2 flex items-center justify-center gap-2 bg-emerald-600 hover:bg-emerald-500 text-white font-bold py-4 rounded-xl shadow-md transition-all active:scale-98 disabled:opacity-70 cursor-pointer text-base"
            >
              {isLoading ? (
                <>
          ...
          <div className="text-center pt-2">
            <p className="text-sm text-zinc-500 dark:text-zinc-400">
              ...
              <button
                ...
                className="font-bold text-emerald-600 hover:text-emerald-500 dark:text-emerald-400 underline underline-offset-4"
              >
                Sign In
              </button>
            </p>
